...
-- ===============================
-- 🎓 COURSES (Each Track has Courses)
-- ===============================
...
-- ===============================
-- 📘 MODULES (Each Course has Modules)
-- ===============================
...
-- ===============================
-- 📚 LESSONS (Each Module has Lessons)
-- ===============================
...
-- ===============================
-- 🧾 ENROLLMENTS (Learners in Tracks)
-- ===============================
...
SELECT 'Alice Smith', 'alice@example.com', 'hashed_password_1', 'learner' FROM DUAL UNION ALL
SELECT 'Bob Johnson', 'bob@example.com', 'hashed_password_2', 'learner' FROM DUAL UNION ALL
SELECT 'Carol Lee', 'carol@example.com', 'hashed_password_3', 'mentor' FROM DUAL UNION ALL
SELECT 'David Brown', 'david@example.com', 'hashed_password_4', 'admin' FROM DUAL;
...
INSERT INTO learning_tracks (track_name, description, duration_weeks)
SELECT 'Data Analytics', 'Learn analytics, data visualization, and Python skills', 12 FROM DUAL UNION ALL
SELECT 'Web Development', 'Full stack web development with MERN stack', 16 FROM DUAL UNION ALL
SELECT 'Machine Learning', 'ML concepts, models, and deployment', 14 FROM DUAL;
DESC courses;
SELECT * FROM courses;
INSERT INTO courses (track_id, course_name, description, order_no)
SELECT 1, 'Data Analytics Foundations', 'Intro to data analytics', 1 FROM DUAL UNION ALL
SELECT 1, 'Python for Data Analytics', 'Learn Python for data manipulation', 2 FROM DUAL UNION ALL
SELECT 2, 'Frontend Development', 'HTML, CSS, JavaScript basics', 1 FROM DUAL UNION ALL
SELECT 2, 'Backend Development', 'Node.js, Express, MongoDB', 2 FROM DUAL UNION ALL
SELECT 3, 'Intro to Machine Learning', 'ML fundamentals', 1 FROM DUAL;

SELECT * FROM modules;
INSERT INTO modules (modules.course_id, module_title, content, order_no)
SELECT '26', 'Introduction to Data', 'Overview of datasets and analytics', 1 FROM DUAL UNION ALL
SELECT '26', 'Data Cleaning', 'Techniques for cleaning data', 2 FROM DUAL UNION ALL
SELECT '27', 'Python Basics', 'Variables, loops, functions', 1 FROM DUAL UNION ALL
SELECT '27', 'Pandas and NumPy', 'Data analysis libraries', 2 FROM DUAL UNION ALL
SELECT '28', 'HTML & CSS', 'Building webpage structure and style', 1 FROM DUAL UNION ALL
SELECT '29', 'Node.js & Express', 'Server-side development', 1 FROM DUAL UNION ALL
SELECT '29', 'Supervised Learning', 'Regression and classification', 1 FROM DUAL;
